...
export default function About() {
    const address = {
        title: 'ĐOÀN - HỘI KHOA CÔNG NGHỆ THÔNG TIN, TRƯỜNG ĐẠI HỌC CÔNG NGHỆ KỸ THUẬT TPHCM',
        content: 'Lầu 2, Trung tâm Tin học, Số 1, Võ Văn Ngân, Phường Linh Chiểu, Tp. Thủ Đức, Tp. Hồ Chí Minh',
    }

    return (
        <>
            <MDBContainer fluid className={clsx('d-flex flex-column', styles.container)}>
                {/* Banner */}
                <div className={styles.banner}>
                    ...
                    <div className={styles.right}>
                        <h1 style={{ fontSize: '3.5rem' }}>ĐOÀN THANH NIÊN - HỘI SINH VIÊN</h1>
                        <h2>KHOA CÔNG NGHỆ THÔNG TIN - TRƯỜNG ĐH CÔNG NGHỆ KỸ THUẬT TPHCM</h2>
                    </div>
                ...
                {/* BCH Đoàn Khoa */}
                <div className={clsx('d-flex flex-column', styles.news)} data-aos="fade-up">
                    ...
                    <img
                        ...
                        alt=""
                        loading="lazy"
                        style={{ borderRadius: '0.75rem', boxShadow: '0 4px 24px rgba(0,0,0,0.1)' }}
                    />
                </div>
                ...
                {/* Kênh liên lạc */}
                <div className={clsx('d-flex flex-column', styles.bluebg, styles.currEvent)}>
                ...
                <div className={clsx('d-flex flex-column', styles.news)}>
                    ...
                    <MDBCard className={styles.news__card} data-aos="fade-up" data-aos-delay="100">
